/**
 * Outline icons from Lucide 1.48.0 (https://lucide.dev, ISC License,
 * Copyright (c) 2026 Lucide Icons and Contributors). Only the icons Systemly uses are
 * copied here, so there is no icon dependency and no icon font to download.
 */
export const ICONS = {
  route:
